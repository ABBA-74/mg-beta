...
const audioNewRecord = new Audio("../assets/audio/new-record.mp3");
const audioFailed = new Audio("../assets/audio/failed.mp3");
const audioComplete = new Audio("../assets/audio/complete.mp3");
let col;
let maxCard;
let arrCard = [];
